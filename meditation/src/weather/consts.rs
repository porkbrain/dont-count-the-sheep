...
pub(crate) const TERMINAL_VELOCITY: f32 = -176.0;
...
pub(crate) const VERTICAL_VELOCITY_ON_DIP: f32 = -256.0;
...
pub(crate) const BLOOM_FADE_OUT_ON_FIRED: Duration =
    Duration::from_millis(2000);
pub(crate) const BLOOM_FADE_OUT_ON_CANCELED: Duration =
...
pub(crate) const ROTATION_SPEED: f32 = 4.0;
