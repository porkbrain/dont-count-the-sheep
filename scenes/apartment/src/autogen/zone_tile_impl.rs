...
#[rustfmt::skip] impl common_top_down::layout::ZoneTile for crate::layout::ApartmentTileKind
...
{ match self { Self::HallwayZone => Some(1266),
...
[Self::Successors]>
{ match self { Self::HallwayZone => Some(&[Self::PlayerApartmentZone,Self::ElevatorZone,Self::PlayerDoorZone]),
