...
impl main_game_lib::top_down::layout::ZoneTile for crate::layout::Building1PlayerFloorTileKind
{ #[inline] fn zone_group(&self) -> Option<main_game_lib::top_down::layout::ZoneGroup>
{
