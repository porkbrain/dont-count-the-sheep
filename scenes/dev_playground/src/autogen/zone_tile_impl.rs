...
impl common_top_down::layout::ZoneTile
    for crate::layout::DevPlaygroundTileKind
{
    #[inline]
    ...
    fn zone_successors(&self) -> Option<&'static [Self::Successors]> {
        match self {
            ...
            Self::ZoneD => {
                Some(&[Self::ZoneA, Self::ZoneE, Self::ZoneF, Self::ZoneG])
            }
            Self::ZoneE => Some(&[Self::ZoneA, Self::ZoneD, Self::ZoneF]),
            Self::ZoneF => Some(&[Self::ZoneA, Self::ZoneD, Self::ZoneE]),
            Self::ZoneG => {
                Some(&[Self::ZoneA, Self::ZoneB, Self::ZoneD, Self::ZoneI])
            }
