...
//! objects?
//!
//! TODO: export this into standalone crate

use std::marker::PhantomData;

use bevy::{utils::hashbrown::HashMap, window::PrimaryWindow};
...
pub fn start_loading_map<T: IntoMap>(
...
/// with your game.
pub fn try_insert_map_as_resource<T: IntoMap>(
    mut commands: Commands,
...
/// TODO: dev only map maker
pub fn visualize_map<T: IntoMap>(map: Res<Map<T>>, mut commands: Commands) {
...
/// TODO: dev only map maker
pub fn change_square_kind<T: IntoMap>(
...
/// TODO: dev only map maker
pub fn export_map<T: IntoMap>(map: Res<Map<T>>) {
